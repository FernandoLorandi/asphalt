      ...
      <div className=" bg-slate-500 h-[600px]">
        <div className="container ">
            <div className="grid lg:grid-cols-12 md:grid-cols-6 gap-8">
                ...
                <Badge className="bg-brand-primary-900 gap-2">
                    ...
                    Com serviços personalizados e atenção aos detalhes, garantimos pavimentos que combinam resistência e estética para todas as suas necessidades.
                    </p>
                    <div className="flex gap-3 mt-2">
                    <Button size='lg' className="bg-brand-secondary-500 gap-3 rounded-sm hover:bg-brand-secondary-600">
                        Entrar em contato
                        <ArrowRight strokeWidth={2} className=" w-5 h-5"></ArrowRight>
                    </Button>
                    <Button size='lg' variant='outline' className="bg-inherit text-white rounded-sm">
                        Saiba mais
                    </Button>
                    </div>                    
                </div>
